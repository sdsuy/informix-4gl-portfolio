...
static char *_functionName = "MAIN";
   ...
   /* CMD : E_CMD_OPEN_FORM_CMD Line 2 E_MET_MAIN_DEFINITION */
   ...
   A4GL_clr_ignore_error_list();
   /* CMD : E_CMD_DISPLAY_FORM_CMD Line 3 E_MET_MAIN_DEFINITION */
   ...
   A4GL_clr_ignore_error_list();
   /* CMD : E_CMD_MENU_CMD Line 8 E_MET_MAIN_DEFINITION */
   ...
   int cmd_no_1= -1; /* n=1 */
      ...
      while (cmd_no_1!= -3) {
          if (cmd_no_1==0) {
            A4GL_clr_ignore_error_list();
            /* CMD : E_CMD_EXT_CMD Line 7 E_MET_MAIN_DEFINITION */
          ...
          if (cmd_no_1==1) {
            A4GL_clr_ignore_error_list();
            /* CMD : E_CMD_EXT_CMD Line 8 E_MET_MAIN_DEFINITION */
            A4GLSTK_setCurrentLine(_module_name,8);
            cmd_no_1= -3;goto MENU_START_1;
            /* FORCE AROUND MENU LOOP AGAIN */ cmd_no_1= -4;goto MENU_START_1;  /* 1 */
         }
         if (cmd_no_1== -1) {
            ...
            A4GL_add_menu_action(m_1, "fgl_exit_menu",1);
         ...
         A4GL_ensure_menu_option(0, m_1, "Exit","EMPTY","",0,0);
   ...
   A4GL_clr_ignore_error_list();
   /* CMD : E_CMD_CLOSE_CMD Line 10 E_MET_MAIN_DEFINITION */
